    ...
    <header className="relative w-full min-h-screen flex flex-col justify-center items-center px-6 overflow-hidden pt-20">
      ...
      <div className="max-w-5xl w-full text-center z-10 space-y-12">
        <h1 className="font-display tracking-tighter leading-none text-primary dark:text-white flex flex-col items-center">
          <span className="text-7xl tablet:text-[9rem] font-black tracking-tight mb-2">
            mini
          </span>
          <span className="text-4xl tablet:text-[2rem] font-light tracking-widest opacity-80">
            home.page
          </span>
        </h1>
        <div className="relative w-full h-32 tablet:h-48 flex items-center justify-center my-8">
          <div className="w-px h-full bg-gradient-to-b from-transparent via-gray-400 dark:via-gray-600 to-transparent absolute"></div>
          {/* <div className="w-24 h-24 tablet:w-32 tablet:h-32 rounded-full border border-gray-200 dark:border-gray-800 bg-white dark:bg-background-dark p-2 z-10 flex items-center justify-center shadow-xl">
            <img
              alt="Agency Symbol"
        ...
        <div className="space-y-6 max-w-2xl mx-auto">
          <h2 className="text-2xl tablet:text-3xl font-bold leading-relaxed">
            작지만 완전한,<br />
            당신만의 웹 공간을 만듭니다.
          </h2>
          <p className="text-gray-500 dark:text-gray-400 leading-7 font-light text-sm tablet:text-base">
